...
class MathematicalAgent:
    def __init__(self, data_path=None):
        ...
        # prompt_template = """You are a helpful mathematical assistant. 
        ...
        if data_path:
            ...
            # Assuming model names can be extracted from column names ending with '_Price'
