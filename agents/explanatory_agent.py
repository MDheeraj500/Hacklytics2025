...
class ExplanatoryAgent:
    def __init__(self, data_path: str = None, metadata_paths: Dict[str, str] = None):
        ...
        # Initialize LLM
        # prompt_template = """You are an expert at explaining complex market analysis and pricing strategies.
        # Please provide a clear, detailed explanation of the following insights:
    ...
    def generate_comparative_analysis(self, recommendations: dict, model_name: str) -> str:
        """Generate comparative analysis focusing on the selected model"""
        # Get the recommendation for current model
    ...
    def explain_recommendation_rationale(self, model_name: str,
        ...
        """Generate detailed explanation of recommendation rationale"""
        model_rec = recommendations[model_name]
    ...
    def generate_business_insights(self, model_name: str,
        ...
        """Generate actionable business insights for a specific model"""
        return {
            ...
            'visualizations': {
                ...
                'feature_importance': self.create_feature_importance_chart(
                    model_name, market_analysis, math_analysis
                )
            }
        }
    ...
    def analyze(self, market_analysis: dict, 
                ...
                model_name: str) -> dict:
        """Generate complete explanatory analysis for a specific model"""
        if not model_name or model_name not in self.models:
            raise ValueError(f"Invalid model name: {model_name}")
        
        return {
            model_name: self.generate_business_insights(
                model_name, market_analysis, math_analysis, recommendations
            )
        } 